...
# 2. Connect without token → WebSocketDisconnect with code 1008
...
6. Run Locust headless: `locust -f tests/load/locustfile.py --headless -u 100 -r 10 --run-time 60s`
7. Write report to `.qwen/agents/reports/testing/<task_id>.md`
